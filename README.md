...
## Test-case creation
This feature adds a test case to each of a tree&rsquo;s user stories that have no child user stories. The new test case is given the same name, description, and owner as its user story. You can also specify a test folder that the test cases will belong to.
