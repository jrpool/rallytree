...
This feature creates a passing result for each test case in a tree if the test case has an owner and has no result. The test-case owner is considered the tester.
