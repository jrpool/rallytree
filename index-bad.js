...
const setOwnerOf = (restAPI, userRef, storyRef) => {
    if (! errorMessage) {
        ...
        changeCount++;
        console.log(`changeCount has become ${changeCount}`);
    }
};
    ...
    if (errorMessage) {
        ...
        .then(
            childrenRef => {
                ...
                console.log(`itemCount has jumped to ${itemCount}`);
                return childRefs;
            },
            error => {
        ...
        .then(
            ownerRef => {
                if (errorMessage) {
                    ...
                    alreadyCount++;
                    console.log(`alreadyCount has become ${alreadyCount}`);
                }
                            ...
                            () => {
                                if (errorMessage) {
                                    ...
                                    .then(
                                        content => {
                                            console.log(
                                                `itemCount ends at ${itemCount}`
                                            );
                                            console.log(
                                                `alreadyCount ends at ${alreadyCount}`
                                            );
                                            console.log(
                                                `changeCount ends at ${changeCount}`
                                            );
                                            const newContent = content.replace(
